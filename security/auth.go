...
// "another_secured_service" for the "basic" security scheme.
func (s *anotherSecuredServicesrvc) BasicAuth(ctx context.Context, user, pass string, scheme *security.BasicScheme) (context.Context, error) {
	//
	// TBD: add authorization logic.
	//
	// In case of authorization failure this function should return
...
// "another_secured_service" for the "jwt" security scheme.
func (s *anotherSecuredServicesrvc) JWTAuth(ctx context.Context, token string, scheme *security.JWTScheme) (context.Context, error) {
	//
	// TBD: add authorization logic.
	//
	// In case of authorization failure this function should return
...
// APIKeyAuth implements the authorization logic for service
// "another_secured_service" for the "api_key" security scheme.
func (s *anotherSecuredServicesrvc) APIKeyAuth(ctx context.Context, key string, scheme *security.APIKeyScheme) (context.Context, error) {
	//
	// TBD: add authorization logic.
	//
	// In case of authorization failure this function should return
...
// OAuth2Auth implements the authorization logic for service
// "another_secured_service" for the "oauth2" security scheme.
func (s *anotherSecuredServicesrvc) OAuth2Auth(ctx context.Context, token string, scheme *security.OAuth2Scheme) (context.Context, error) {
	//
	// TBD: add authorization logic.
	//
	// In case of authorization failure this function should return
