...
// The another secured service exposes endpoints that require valid
...
// key.
const ServiceName = "another_secured_service"
...
// Creds is the result type of the another_secured_service service signin
// method.
type Creds struct {
	// JWT token
	JWT string
...
// SecurePayload is the payload type of the another_secured_service service
// secure method.
...
// DoublySecurePayload is the payload type of the another_secured_service
// service doubly_secure method.
...
// AlsoDoublySecurePayload is the payload type of the another_secured_service
// service also_doubly_secure method.
