...
//
// another_secured_service client
//
// Command:
...
// Client is the "another_secured_service" service client.
type Client struct {
...
// NewClient initializes a "another_secured_service" service client given the
// endpoints.
...
// Signin calls the "signin" endpoint of the "another_secured_service" service.
...
// Secure calls the "secure" endpoint of the "another_secured_service" service.
...
// DoublySecure calls the "doubly_secure" endpoint of the
