...
//
// another_secured_service client HTTP transport
//
// Command:
...
// Client lists the another_secured_service service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the another_secured_service
// service servers.
func NewClient(
	scheme string,
	host string,
...
// another_secured_service service signin server.
func (c *Client) Signin() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("another_secured_service", "signin", err)
		}
		return decodeResponse(resp)
	}
}

// Secure returns an endpoint that makes HTTP requests to the
// another_secured_service service secure server.
func (c *Client) Secure() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("another_secured_service", "secure", err)
		}
		return decodeResponse(resp)
	}
}
...
// another_secured_service service doubly_secure server.
func (c *Client) DoublySecure() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("another_secured_service", "doubly_secure", err)
		}
		return decodeResponse(resp)
	}
}
...
// another_secured_service service also_doubly_secure server.
func (c *Client) AlsoDoublySecure() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("another_secured_service", "also_doubly_secure", err)
		}
		return decodeResponse(resp)
	}
}
