...
//
// another_secured_service HTTP client types
//
// Command:
...
// NewSigninCredsOK builds a "another_secured_service" service "signin"
// endpoint result from a HTTP "OK" response.
func NewSigninCredsOK(body *SigninResponseBody) *anothersecuredservice.Creds {
	v := &anothersecuredservice.Creds{
		JWT:        *body.JWT,
		APIKey:     *body.APIKey,
...
// NewSigninUnauthorized builds a another_secured_service service signin
// endpoint unauthorized error.
func NewSigninUnauthorized(body SigninUnauthorizedResponseBody) anothersecuredservice.Unauthorized {
	v := anothersecuredservice.Unauthorized(body)
	return v
}

// NewSecureInvalidScopes builds a another_secured_service service secure
// endpoint invalid-scopes error.
func NewSecureInvalidScopes(body SecureInvalidScopesResponseBody) anothersecuredservice.InvalidScopes {
	v := anothersecuredservice.InvalidScopes(body)
	return v
}

// NewSecureUnauthorized builds a another_secured_service service secure
// endpoint unauthorized error.
func NewSecureUnauthorized(body SecureUnauthorizedResponseBody) anothersecuredservice.Unauthorized {
	v := anothersecuredservice.Unauthorized(body)
	return v
}

// NewDoublySecureInvalidScopes builds a another_secured_service service
// doubly_secure endpoint invalid-scopes error.
func NewDoublySecureInvalidScopes(body DoublySecureInvalidScopesResponseBody) anothersecuredservice.InvalidScopes {
	v := anothersecuredservice.InvalidScopes(body)
	return v
}

// NewDoublySecureUnauthorized builds a another_secured_service service
// doubly_secure endpoint unauthorized error.
func NewDoublySecureUnauthorized(body DoublySecureUnauthorizedResponseBody) anothersecuredservice.Unauthorized {
	v := anothersecuredservice.Unauthorized(body)
	return v
}

// NewAlsoDoublySecureInvalidScopes builds a another_secured_service service
// also_doubly_secure endpoint invalid-scopes error.
func NewAlsoDoublySecureInvalidScopes(body AlsoDoublySecureInvalidScopesResponseBody) anothersecuredservice.InvalidScopes {
	v := anothersecuredservice.InvalidScopes(body)
	return v
}

// NewAlsoDoublySecureUnauthorized builds a another_secured_service service
// also_doubly_secure endpoint unauthorized error.
func NewAlsoDoublySecureUnauthorized(body AlsoDoublySecureUnauthorizedResponseBody) anothersecuredservice.Unauthorized {
	v := anothersecuredservice.Unauthorized(body)
	return v
}
