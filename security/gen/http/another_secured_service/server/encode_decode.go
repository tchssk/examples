...
//
// another_secured_service HTTP server encoders and decoders
//
// Command:
...
// another_secured_service signin endpoint.
func EncodeSigninResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*anothersecuredservice.Creds)
		enc := encoder(ctx, w)
...
// another_secured_service endpoint.
func EncodeSigninError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, error) error {
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		switch en.ErrorName() {
		case "unauthorized":
			res := v.(anothersecuredservice.Unauthorized)
			enc := encoder(ctx, w)
...
// another_secured_service secure endpoint.
...
func EncodeSecureError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, error) error {
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		switch en.ErrorName() {
		case "invalid-scopes":
			res := v.(anothersecuredservice.InvalidScopes)
			enc := encoder(ctx, w)
...
// doubly_secure another_secured_service endpoint.
...
// the another_secured_service also_doubly_secure endpoint.
...
// also_doubly_secure another_secured_service endpoint.
