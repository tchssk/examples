...
import (
	"fmt"
	"github.com/goadesign/examples/form_encoding/client"
	"github.com/goadesign/examples/form_encoding/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "survey-cli",
		Short: `CLI client for the survey service`,
	}
